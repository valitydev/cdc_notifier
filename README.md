...
- сконфигурировать стрим в конфиге cdc_progressor. пример:
  ...
  примечание: не требуется создавать слот под каждый неймспейс, если слот к требуемой БД ранее сконфигурирован, то
  нужно добавить описание стрима в описание существующего слота
